...
void jni_reflect_java_class(JavaClass ** p_jc, JNIEnv *env) {
    ...
    jclass player_class = (*env)->FindClass(env, "com/standisland/god/media/editor/VideoEditor");
    ...
    jclass media_codec_class = (*env)->FindClass(env, "com/standisland/god/media/decoder/MediaCodecDecode");
    ...
    java_class->codec_releaseOutPutBuffer = (*env)->GetMethodID(env, media_codec_class, "releaseOutputBuffer",  "(IZ)V");
