...
public class ThumbLineBar extends FrameLayout {
    ...
    protected long mCurrDuration = 0;                           //当前视频播放时刻
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case WHAT_THUMBNAIL_VIEW_AUTO_MOVE:
                    Log.d("ThumbLineBar", "WHAT_THUMBNAIL_VIEW_AUTO_MOVE : " + duration);
                ...
                case WHAT_TIMELINE_ON_SEEK:
                    Log.d("ThumbLineBar", "WHAT_TIMELINE_ON_SEEK : " + duration);
                    mBarSeekListener.onThumbLineBarSeek(duration);
                    break;
                case WHAT_TIMELINE_FINISH_SEEK:
                    mBarSeekListener.onThumbLineBarSeekFinish(duration);
                    Log.d("ThumbLineBar", "WHAT_TIMELINE_FINISH_SEEK : " + duration);
                    break;
                default:
                    break;
        ...
        if (mBarSeekListener == null) {
            ...
            mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
                ...
                public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                    ...
                    //用户在拖动预览条
                    if (mBarSeekListener != null && (mIsTouching || mScrollState == RecyclerView.SCROLL_STATE_SETTLING)) {
                        Message msg = mUIHandler.obtainMessage(WHAT_TIMELINE_ON_SEEK);
                        Bundle data = new Bundle();
                        data.putLong(KEY_DURATION, duration);
                        msg.setData(data);
                        mUIHandler.sendMessage(msg);
                        Log.d(TAG, "onScrolled duration is " + duration + ",send WHAT_TIMELINE_ON_SEEK to seek!");
                    }
    ...
    protected class PlayThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                ...
                Log.d(TAG, "playerCurr : " + mCurrDuration + "   mLastDuration : " + mLastDuration);
