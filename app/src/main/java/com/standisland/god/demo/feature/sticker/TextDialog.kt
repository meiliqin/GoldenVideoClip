...
import com.standisland.god.demo.common.adapter.ColorViewHolder
import com.standisland.god.demo.common.adapter.ColorViewPagerAdapter
import com.standisland.god.demo.common.view.WheelView
import java.io.File
...
class TextDialog : DialogFragment() {
  ...
  companion object {
    ...
    private val ID_ICON_ARRAY = intArrayOf(R.drawable.ic_keyboard, R.drawable.ic_text_color,
        R.drawable.ic_font, R.drawable.ic_effect
    )
  ...
  override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
    ...
    mPagerViewStack.add(contentView.findViewById(R.id.font_layout))
  ...
  private val mOnTabSelectedListener: TabLayout.OnTabSelectedListener = object : TabLayout.OnTabSelectedListener {
    override fun onTabSelected(tab: TabLayout.Tab) {
      ...
      if (checkedIndex == 0) {
        ...
        closeKeyboard()
        for(i in 0 until ID_TITLE_ARRAY.size){
          mPagerViewStack[i].visibility = View.GONE
        }
