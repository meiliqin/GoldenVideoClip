...
package com.standisland.god.demo.feature.effect.view
...
import com.standisland.god.demo.feature.effect.EffectAdapter
...
class EffectFilterFragment : Fragment() {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    mAdapter =
      EffectAdapter(view.context, effects)
